...
# config = yaml.load(r'/home/jq/Code/torch/hiucdv2_multi_bs8_siamcontrast.yaml', Loader=yaml.FullLoader)
# cfg = EasyDict(config)
...
class SiamContrast(nn.Module):
    ...
    def __init__(self, num_class):
        super().__init__()
        f = open(r'/home/jq/Code/torch/cd_models/siamcontrast/hiucdv2_multi_bs8_siamcontrast.yaml', 'r')
        ...
        self.proj_head = ProjectionHead(dim_in=list(self.seg_encoder.out_channels)[-1], proj_dim=self.cfg.SEG_LOSS.proj_dim)
        ...
        self.cd_head = SegmentationHead(
            ...
            out_channels=1, #self.cfg.MODEL.out_channels,
            activation=None,
            kernel_size=1,
            upsampling=upsampling,
        )
    ...
    def forward(self, x1, x2):
        ...
        return cd_logits, seg1_logits, seg2_logits
