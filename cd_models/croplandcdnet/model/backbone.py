...
class ResNet(nn.Module):
    ...
    def __init__(self,  block, layers, output_stride, BatchNorm, pretrained=True, in_c=3):
        ...
        first_channels = 2048
        self.pos_s16 = PA(first_channels,32) #PA(512, 32)
        self.pos_s8 = PA(first_channels//4, 32)
        self.pos_s4 = PA(first_channels//8, 32)
...
def build_backbone(backbone, output_stride, BatchNorm, in_c=3, pretrained=False):
    if backbone == 'resnet50':
        return ResNet50(output_stride, BatchNorm, in_c=in_c,pretrained=False)
    elif backbone == 'resnet34':
        return ResNet34(output_stride, BatchNorm, in_c=in_c,pretrained=False)
    elif backbone == 'resnet18':
        return ResNet18(output_stride, BatchNorm, in_c=in_c,pretrained=False)
    else:
        raise NotImplementedError
