...
class SSESN(nn.Module):
    ...
    def forward(self, input1, input2):#input 1, 6, 512, 512
...
class CA(nn.Module):
    def __init__(self, n_classes):
        ...
        self.conv_gray_final = nn.Conv2d(256, 1, kernel_size=1, stride=1)
    ...
    def forward(self, x1, x2, input):
        ...
        return x_gray, x_color1, x_color2 
