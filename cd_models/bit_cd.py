...
def BIT_CD(num_class=2, input_nc=3, init_type='normal', init_gain=0.02, gpu_ids=[]):
    '''
    @Article{chen2021a,
    ...
    '''
    return BASE_Transformer(input_nc=input_nc, output_nc=num_class, token_len=4, resnet_stages_num=4,
...
#     https://github.com/justchenhao/BIT_CD.git
#     '''
#     def __init__(self,num_class=2, input_nc=3):
#         super(BIT_CD).__init__(input_nc=input_nc, output_nc=num_class, token_len=4,resnet_stages_num=4,with_pos='learned',
