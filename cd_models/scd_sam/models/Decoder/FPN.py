...
class FPNNeck(nn.Module):
    def __init__(self, inplanes):
        ...
        self.stage2_Conv1 = Conv3Relu(inplanes * 4, inplanes * 2)  # channel: 2*inplanes ---> 2*inplanes
        self.stage3_Conv1 = Conv3Relu(inplanes * 8, inplanes * 4)  # channel: 8*inplanes ---> 2*inplanes
    ...
    def forward(self, ms_feats):
        ...
        change3 = self.stage3_Conv1(torch.cat([fa3, fb3], 1))  # inplanes * 2
