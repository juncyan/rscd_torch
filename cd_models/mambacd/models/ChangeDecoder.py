...
class ChangeDecoder(nn.Module):
    ...
    def forward(self, pre_features, post_features):
        ...
        ct_tensor_42 = torch.empty(B, C, H, 2*W).cuda(device)
        ...
        ct_tensor_43 = torch.empty(B, C, H, 2*W).cuda(device)
