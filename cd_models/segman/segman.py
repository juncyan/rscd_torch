...
@register_model
def SegMANEncoder_t(img_size=256, pretrained=r"/home/jq/Code/weights/segman/SegMAN_Encoder_t.pth.tar", pretrained_cfg=None, **args):
    model = SegMANEncoder(
        image_size=img_size,
...
@register_model
def SegMANEncoder_s(img_size=256, pretrained=r"/home/jq/Code/weights/segman/SegMAN_Encoder_s.pth.tar", pretrained_cfg=None, **args):
    model = SegMANEncoder(
        image_size=img_size,
...
@register_model
def SegMANEncoder_b(img_size=256, pretrained=r"/home/jq/Code/weights/segman/SegMAN_Encoder_b.pth.tar", pretrained_cfg=None, **args):
    model = SegMANEncoder(
        image_size=img_size,
