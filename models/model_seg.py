...
from .mkdc import CrossDimensionalGroupedAggregation, RepLKSSMBlock, RepLKSSMLayer
...
class RepLKSSM_Seg(nn.Module):
    def __init__(self, num_cls=2) -> None:
        ...
        self.conv1 = nn.Sequential(nn.Conv2d(768, 64, 1), nn.BatchNorm2d(64), nn.ReLU6())
        self.conv2 = nn.Sequential(nn.Conv2d(192, 64, 1), nn.BatchNorm2d(64), nn.ReLU6())

        self.up1 = RepLKSSMBlock(64, [17, 13])
        self.up2 = RepLKSSMBlock(64, [13])

        self.df = CrossDimensionalGroupedAggregation(64,64,64)

        self.cls = nn.Conv2d(64, num_cls, 7, padding=3)
