...
from cd_models.utils import ConvBnReLU, ConvBn, DepthWiseConv2D
...
class BMF(nn.Module):
    ...
    def forward(self, x1, x2):
        ...
        # split = (z.chunk(2, axis=2) for z in yc.chunk(2, axis=3))
        # merge = paddle.concat(tuple(paddle.concat((x2, x1), 1) for (x1, x2) in split), 1)
