...
class LKAUChange(nn.Module):
    def __init__(self,in_channels=3, num_classes=2):
        ...
        self.lkff1 = LKAFF(64, 7)
        self.lkff2 = LKAFF(128, 7)
        self.lkff3 = LKAFF(256, 7)
        self.lkff4 = LKAFF(512, 7)

        self.ppm = PFF(512, 512)
...
class LKUChange(nn.Module):
    def __init__(self,in_channels=3, num_classes=2):
        ...
        self.lkff1 = LKFF(64, 7)
        self.lkff2 = LKFF(128, 7)
        self.lkff3 = LKFF(256, 7)
        self.lkff4 = LKFF(512, 7)

        self.ppm = PFF(512,512)
        
        self.up1 = SFFUp(1024, 256)
        self.up2 = SFFUp(512, 128)
        self.up3 = SFFUp(256, 64)
        self.up4 = SFFUp(128, 64)
...
if __name__ == "__main__":
    ...
    m = LKUChange(in_channels=6, num_classes=2).to("gpu")
    y = m(x)
    # for i in y:
    print(y.shape)
